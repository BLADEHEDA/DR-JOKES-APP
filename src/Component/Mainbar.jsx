  ...
  return (
    <div className='mainbar '>
        ...
        <div className="main-section">
            <h1 className="main-head text-3xl font-bold text-center md:text-start">MAKE YOUR DAY REMARKABLY JOYFUL</h1>
            <p className="main-content text-center mt-1 mb-[1em]">
